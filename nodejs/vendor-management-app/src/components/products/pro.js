...
function ProductData() {
    ...
    const [product] = useState([
        ...
        {
            url: 'https://pixeltemplate.com/wordpress/shopeur/wp-content/uploads/2020/08/17-282x280.jpg',
            name: 'Cup red Color',
            category: 'Cup',
            seller: 'ABS Ltd',
            price: 100
        ...
        {
            url: 'https://pixeltemplate.com/wordpress/shopeur/wp-content/uploads/2020/08/22-282x280.jpg',
            name: 'Cup red Color',
            category: 'Cup',
            seller: 'ABS Ltd',
            price: 100
